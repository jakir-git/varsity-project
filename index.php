        ...
        <div class="mn-content fixed-sidebar">
            ...
            <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion" style="">
                    <li>&nbsp;</li>
                    <li class="no-padding"><a class="waves-effect waves-grey" href="index.php"><i class="fa fa-user"></i>Employe Login</a></li>
                    <li class="no-padding"><a class="waves-effect waves-grey" href="forgot-password.php"><i class="fa fa-lock"></i>Emp Password Recovery</a></li>
                
                       <li class="no-padding"><a class="waves-effect waves-grey" href="admin/"><i class="fa fa-desktop"></i>Admin Login</a></li>
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                          ...
                          <div class="col s12 m6 offset-m3" style="margin-top:70px;">
                                       ...
                                       <div class="row">
                                           <form class="col s12" name="signin" method="post">
                                               ...
                                               <div class="col s12 right-align m-t-sm">
                                                    <a class="waves-effect waves-light btn waves-input-wrapper" href="emp-registration.php">Registration</a>
