...
$sql="INSERT INTO tblleavetype(LeaveType,LeaveLimit,Description) VALUES(:leavetype,:leavelimit,:description)";
                                ...
                                <div class="row">
                                    <form class="col s12" name="chngpwd" method="post">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="input-field col s12">
                                                <input id="leavelimit" type="number"  class="validate" autocomplete="off" name="leavelimit"  required>
                                                <label for="leavetype">Leave Limit</label>
                                            </div>
