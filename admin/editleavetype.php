...
$leavelimit=$_POST['leavelimit'];
$description=$_POST['description'];
$sql="update tblleavetype set LeaveType=:leavetype,LeaveLimit=:leavelimit,Description=:description where id=:lid";
$query = $dbh->prepare($sql);
$query->bindParam(':leavetype',$leavetype,PDO::PARAM_STR);
$query->bindParam(':leavelimit',$leavelimit,PDO::PARAM_INT);
                ...
                <div class="row">
                    ...
                    {               ?>  
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="input-field col s12">
                                                <input id="leavelimit" type="text"  class="validate" autocomplete="off" name="leavelimit" value="<?php echo htmlentities($result->LeaveLimit);?>"  required>
